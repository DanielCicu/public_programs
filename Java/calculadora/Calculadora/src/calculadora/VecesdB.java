 ...
 * @author Camil
 */
public class VecesdB extends javax.swing.JFrame {

    /**
     * Creates new form VecesdB
     */
    public VecesdB() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(num, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 80, 236, -1));
        ...
        getContentPane().add(Calcular, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, -1, -1));

        ecuacion.setFont(new java.awt.Font("Constantia", 1, 18)); // NOI18N
        ecuacion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/WhatsApp Image 2021-02-15 at 11.09.13 PM.jpeg"))); // NOI18N
        ecuacion.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        getContentPane().add(ecuacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 20, -1, 40));
        ...
        getContentPane().add(Resultado, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 298, 40));
        ...
        getContentPane().add(Borrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 120, -1, -1));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 340, 250));
    ...
    private void CalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalcularActionPerformed
        ...
        try{
            ...
            if (variable>0){
                double dB = 10*Math.log10(variable);
                this.Resultado.setText(dB + " dB");
            }
            else{
