 ...
 * @author Camil
 */
public class dBwWatts extends javax.swing.JFrame {

    /**
     * Creates new form dBwWatts
     */
    public dBwWatts() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(Borrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 120, -1, -1));
        ...
        getContentPane().add(num, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 236, -1));
        ...
        getContentPane().add(Calcular, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, -1, -1));

        ecuacion.setFont(new java.awt.Font("Constantia", 1, 18)); // NOI18N
        ecuacion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/WhatsApp Image 2021-02-15 at 11.32.12 PM.jpeg"))); // NOI18N
        ecuacion.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        getContentPane().add(ecuacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, 150, -1));
        ...
        getContentPane().add(Resultado, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 250, 40));
