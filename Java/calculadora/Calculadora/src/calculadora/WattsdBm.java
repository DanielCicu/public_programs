 ...
 * @author Camil
 */
public class WattsdBm extends javax.swing.JFrame {

    /**
     * Creates new form WattsdBm
     */
    public WattsdBm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(Calcular, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 140, -1, -1));

        ecuacion.setFont(new java.awt.Font("Constantia", 1, 18)); // NOI18N
        ecuacion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/WhatsApp Image 2021-02-15 at 11.13.07 PM.jpeg"))); // NOI18N
        ecuacion.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        getContentPane().add(ecuacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 30, 230, 50));
        ...
        getContentPane().add(Resultado, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 210, 298, 40));
        ...
        getContentPane().add(Borrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 140, -1, -1));
        ...
        getContentPane().add(num, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 100, 236, -1));
    ...
    private void CalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalcularActionPerformed
        ...
        try{
            ...
            if (variable>0){
                double dB = 10*Math.log10(variable/(0.001));
                this.Resultado.setText(dB + " dBm");
            }
            else{
