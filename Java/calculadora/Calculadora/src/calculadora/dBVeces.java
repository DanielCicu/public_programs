 ...
 * @author Camil
 */
public class dBVeces extends javax.swing.JFrame {

    /**
     * Creates new form dBVeces
     */
    public dBVeces() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(num, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, 236, -1));
        ...
        getContentPane().add(Calcular, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 120, -1, -1));

        ecuacion.setFont(new java.awt.Font("Constantia", 1, 18)); // NOI18N
        ecuacion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/WhatsApp Image 2021-02-15 at 11.09.27 PM.jpeg"))); // NOI18N
        ecuacion.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        getContentPane().add(ecuacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 10, -1, 50));
        ...
        getContentPane().add(Resultado, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 298, 40));
        ...
        getContentPane().add(Borrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 120, -1, -1));
    ...
    private void CalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalcularActionPerformed
        String a = this.num.getText();
         ...
         try{
             ...
             double dB = Math.pow(10,variable/10);
